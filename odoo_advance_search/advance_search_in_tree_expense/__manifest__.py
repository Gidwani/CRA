{
    "name": "Advance Search in tree/list view for Expence",
    "version": "16.0.1.0.0",
    "summary": "Advance Search number in tree/list view for Expence.",
    "category": "Other",
    ...
    "depends": ["odoo_advance_search", "hr_expense"],
    "data": [],
    "assets": {
        "web.assets_backend": [
            "/advance_search_in_tree_expense/static/src/xml/list_render.xml"
        ],
    },
